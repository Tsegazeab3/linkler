...
from .views import (
    ...
    TravelerOnboardingView, VerificationDocumentUploadView, NotificationViewSet, ReportViewSet, BlockedUserViewSet
)
...
router.register('blocked-users', BlockedUserViewSet)
