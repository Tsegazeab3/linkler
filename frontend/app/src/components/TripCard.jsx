...
const TripCard = ({ trip }) => {
  ...
  return (
    <div className="rounded-lg max-w-4xl mx-auto my-4 overflow-hidden flex flex-col md:flex-row shadow-xl bg-gradient-to-br from-white to-gray-100 group">
      <div className="w-full md:w-1/2 shrink-0 relative overflow-hidden">
        ...
        <div className="absolute top-4 right-4 flex space-x-2">
          <button 
            onClick={handleChat}
            className="p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-white transition-colors text-blue-600"
          >
          ...
          <button 
            ...
            className={`p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-white transition-colors ${isFollowing ? 'text-gray-400' : 'text-blue-500'}`}
          >
            {isFollowing ? (
      ...
      <div className="w-full md:w-1/2 p-6 flex flex-col justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mb-4 h-20 overflow-y-auto no-scrollbar">{bio}</p>
        </div>
