...
const ExperiencesPage = () => {
  ...
  useEffect(() => {
    ...
    getExperiences(searchQuery, activeCategory, activeRegion, activeCountry, getApiQuickFilters(), '', 'experience')
      .then(response => {
  ...
  return (
    <div className="min-h-screen p-4 lg:p-8">
      <header className="mb-10">
        <h1 className="text-5xl font-black italic uppercase tracking-tighter text-ui-text-main leading-none">Experiences</h1>
        <p className="text-ui-muted font-black uppercase tracking-[0.3em] text-[10px] mt-3">Curated adventures and local culture</p>
      </header>
        ...
        <div className="lg:col-span-3">
          <div className="flex flex-col space-y-8">
            ...
            <div className="relative group max-w-2xl">
                <input 
                  type="text" 
                  placeholder="Search experiences, activities, or guides..." 
                  value={searchQuery}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {items.length > 0 ? (
                  ...
                  <div className="col-span-full text-center py-20 bg-ui-white rounded-3xl border-2 border-dashed border-ui-border">
                    <p className="text-ui-text-secondary font-medium italic">No experiences found.</p>
                  </div>
                )}
              </div>
            )}
