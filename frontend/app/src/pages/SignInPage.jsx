...
function SignInPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[var(--color-linkler-bg)] p-4 sm:p-8">
      <div className="flex w-full max-w-5xl mx-auto bg-ui-white rounded-3xl shadow-xl overflow-hidden min-h-[600px] border border-ui-border">
        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-ui-white relative">
          <div className="w-full max-w-sm mx-auto space-y-8">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl font-bold text-ui-text-main tracking-tight">Sign In</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-ui-text-main">Email</Label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <svg className="h-4 w-4 text-ui-muted" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-ui-bg-alt border-ui-border text-ui-text-main"
                    disabled={loading}
                  />
                </div>
              </div>
            ...
            <Button
              variant="outline"
              size="lg"
              className="w-full relative py-6 border-ui-border text-ui-text-main hover:bg-ui-bg-alt"
